...
# 定义输入和输出文件夹路径
input_folder = 'C:\\Users\\19108\\Desktop\\workspace\\Baseline\\Physical Reservoir Computing for Handwriting Digit Number\\minist'  # 替换为28×28像素图片的文件夹路径
output_folder = 'C:\\Users\\19108\\Desktop\\workspace\\Baseline\\Physical Reservoir Computing for Handwriting Digit Number\\number'  # 替换为保存20×20像素图片的文件夹路径
output_data = 'C:\\Users\\19108\\Desktop\\workspace\\Baseline\\Physical Reservoir Computing for Handwriting Digit Number\\data'  # 保存 .npy 文件的文件夹
